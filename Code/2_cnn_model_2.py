...
# Train the Model
# Time the training
# Use variable learning rate schedule
...
print()
print('The time taken to train the model 2.1 is: ')
print(end - start)
# -----------------------------------------------------------------------------------
# Test the Model
...
# -----------------------------------------------------------------------------------
print('Test Accuracy of the model 2.1 on the ', len(test_data), ' test images: %d %%' % (100 * correct / total))
# -----------------------------------------------------------------------------------
...
cax = ax.matshow(cm)
plt.title('Confusion matrix of the Model 2.1 Classifier')
fig.colorbar(cax)
...
torch.save(cnn.state_dict(), 'cnn_model_21.pkl')
...
plt.title('Figure 2.1. The Train Loss for Model 2.1')
plt.show()
