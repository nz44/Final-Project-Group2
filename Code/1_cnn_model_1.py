...
print()
print('The time taken to train the model 1 is: ')
print(end - start)
# -----------------------------------------------------------------------------------
# Test the Model
...
cax = ax.matshow(cm)
plt.title('Confusion matrix of the Model 1 Classifier')
fig.colorbar(cax)
...
torch.save(cnn.state_dict(), 'cnn_model_1.pkl')
...
plt.title('Figure 1. The Train Loss for Model 1')
plt.show()
