...
print()
print('The time taken to train the model 4 is: ')
print(end - start)
# -----------------------------------------------------------------------------------
# Test the Model
...
# -----------------------------------------------------------------------------------
print('Test Accuracy of the model 4 on the ', len(test_data), ' test images: %d %%' % (100 * correct / total))
# -----------------------------------------------------------------------------------
...
cax = ax.matshow(cm)
plt.title('Confusion matrix of the Model 4 Classifier')
fig.colorbar(cax)
...
torch.save(cnn.state_dict(), 'cnn_model_4.pkl')
...
plt.title('Figure 4. The Train Loss for Model 4')
plt.show()
