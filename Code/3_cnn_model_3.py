...
print()
print('The time taken to train the model 3 is: ')
print(end - start)
# -----------------------------------------------------------------------------------
# Test the Model
...
# -----------------------------------------------------------------------------------
print('Test Accuracy of the model 3 on the ', len(test_data), ' test images: %d %%' % (100 * correct / total))
# -----------------------------------------------------------------------------------
...
cax = ax.matshow(cm)
plt.title('Confusion matrix of the Model 3 Classifier')
fig.colorbar(cax)
...
torch.save(cnn.state_dict(), 'cnn_model_3.pkl')
...
plt.title('Figure 3. The Train Loss for Model 3')
plt.show()
